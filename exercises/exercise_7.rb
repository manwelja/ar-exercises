...
new_store = Store.create(name: store_name, annual_revenue: 500000, mens_apparel: false, womens_apparel: false)

#to print field and error mesage on separate line use:
